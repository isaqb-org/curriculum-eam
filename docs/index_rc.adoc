...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-eam/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-eam/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
