...
== Status 
image:https://github.com/isaqb-org/curriculum-eam/workflows/CI%20-%20Releases%20and%20Master/badge.svg?branch=master["CI – Releases and Master"]
image:https://img.shields.io/github/last-commit/isaqb-org/curriculum-eam/master.svg["Last commit"]
